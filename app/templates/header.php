    ...
    <div class="container d-flex">
        <div class="contact-info mr-auto">
            ...
            <span class="d-none d-lg-inline-block"><i class="icofont-clock-time icofont-rotate-180"></i>
                Mardi-Dimanche: 11 h 45 - 14 h 30 et 19 h 30 - 22 h 00</span>
        </div>
        <div class="languages">
            <ul>
                <!--//TODO: Sprint 4 : make the languages change work-->
...
<header id="header" class="fixed-top">
    <div class="container d-flex align-items-center">
        ...
        <h1 class="logo mr-auto"><a href="index.php">La pousse de bambou</a></h1>
        ...
        <nav class="nav-menu d-none d-lg-block">
            <ul>
                ...
                <li class="book-a-table text-center"><a href="index.php?page=bookTable">Réserver</a></li>
            </ul>
        </nav><!-- .nav-menu -->
    </div>
</header><!-- End Header -->