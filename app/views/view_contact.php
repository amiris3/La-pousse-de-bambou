                ...
                <div class="col-lg-8 mt-5 mt-lg-0">
                    ...
                    <form action="#" method="post" role="form" class="php-email-form">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="message" id="message" rows="4" maxlength="199" data-rule="required" data-msg="Ecrivez-nous quelque chose" placeholder="Message"></textarea>
                            <div class="validate"></div>
                        </div>
