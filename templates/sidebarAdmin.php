<?php
$tab = ['adminMain', 'adminRes', 'adminPlatsInsertUpdate', 'adminPlatsDelete', 'adminClients', 'adminMessages'];
$actives = [];
...
<nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
    <div class="sidebar-sticky pt-3">
        <ul class="nav flex-column text-justify">
            ...
            <li class="nav-item">
                <a class="nav-link <?=$actives[1]?>" href="#">
            ...
            <li class="nav-item">
                <a class="nav-link <?=$actives[4]?>" href="#">
